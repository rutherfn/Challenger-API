package com.nickrutherford.challenger.api.controller

import com.nickrutherford.challenger.api.models.Challenge
import com.nickrutherford.challenger.api.repository.ChallengeRepository
...
class ChallengeController (@Autowired private val challengeRepository: ChallengeRepository) {
    ...
    // updates a challenge
    @PutMapping("/challeng/(challengeId}")
